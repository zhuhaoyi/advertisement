  ...
  <tr>
    ...
    <td width='80%' align="right" valign="bottom">
      ...
      <td align="right" height="26" style="padding-right:10px;line-height:26px;">
        	您好：<span class="username"><?=$_SESSION['adminname']?></span>，欢迎使用本系统!
        	[<a href="/" target="_blank">网站主页</a>]
        	[<a href="/web/admin.php?type=loginout" target="_top">注销退出</a>]&nbsp;
      </td>
      </tr>
      <tr>
		...
		<dd><div class='itemsel' id='item1' onMouseMove="mv(this,'move',1);" onMouseOut="mv(this,'o',1);"><a href="main.php" onclick="changeSel(1)" target="main">后台主页</a></div></dd>
        <dd>
		  <div class='item' id='item3' onMouseMove="mv(this,'m',3);" onMouseOut="mv(this,'o',3);"><a href="menu_all.php" onclick="changeSel(3)" target="menu">全局设置</a></div></dd>
		
		<dd>
		  <div class='item' id='item2' onMouseMove="mv(this,'m',2);" onMouseOut="mv(this,'o',2);"><a href="menu.php" onclick="changeSel(2)" target="menu">会员管理</a></div></dd>
		<dd>
