...
<div class="content_middle">
    ...
    <div class="right">
        ...
        <div id="right_message">
            <form action="wangzhan.php" method="post" name="hiform">
                <div class="enter">
                    ...
                    <input name="laiurl" type="hidden" value="网站-索股">
...
<div class="text" style="cursor:default;">
    <span id="close"><a href="http://www.djhlyw.com/ngwz.php">×</a></span>
    <span id="sure"><a href="http://www.djhlyw.com/ngwz.php">确定</a></span>
    <h1>恭喜您成功参与国诚牛股天机星活动，24小时内将会收到我方电话或短信联系！</h1>
</div>
<!--站长统计-->
