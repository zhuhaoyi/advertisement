...
<div class="bgi">
	<div class="middle">
		...
		<div class="middle_right">
			<form action="wangzhan.php" method="post" name="hiform" id="form1">
				<div class="zhengu">
...
<div class="text" style="cursor:default;">
	<span id="close"><a href="http://www.djhlyw.com/zgwz.php">×</a></span>
	<span id="sure"><a href="http://www.djhlyw.com/zgwz.php">确定</a></span>
