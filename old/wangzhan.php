		...
		if(strlen($mobile) == 11){
			...
			if(preg_match($exp,$mobile)){
				...
				if(!empty($reg_install)){
					echo '<script>location.href="ngwz1.php"</script>';
				}
			}else{
				echo '<script>location.href="ngwz.php"</script>';
			}			
		}else{
			echo '<script>location.href="ngwz.php"</script>';
		}
	...
	if($mobile != "" && $username != "" && $laiurl != ""){
		...
		if(strlen($mobile) == 11){
			...
			if(preg_match($exp,$mobile)){
				...
				if(!empty($reg_install)){
					echo '<script>location.href="zgwz1.php"</script>';
				}
			}else{
				echo '<script>location.href="zgwz.php"</script>';
			}
		}else{
			echo  '<script>location.href="zgwz.php"</script>';
		}
