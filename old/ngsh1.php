...
<div class="content_middle">
    ...
    <div class="right">
        ...
        <div id="right_message">
            <form action="souhu.php" method="post" name="hiform">
                <div class="enter">
                    ...
                    <input name="laiurl" type="hidden" value="搜狐-索股">
...
<div class="text" style="cursor:default;">
    <span id="close"><a href="http://www.djhlyw.com/ngsh.php">×</a></span>
    <span id="sure"><a href="http://www.djhlyw.com/ngsh.php">确定</a></span>
