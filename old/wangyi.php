		...
		if(strlen($mobile) == 11){
			...
			if(preg_match($exp,$mobile)){
				...
				if(!empty($reg_install)){
					echo '<script>location.href="ngwy1.php"</script>';
				}
			}else{
				echo '<script>location.href="ngwy.php"</script>';
			}
		}else{
			echo '<script>location.href="ngwy.php"</script>';
		}
	...
	if($mobile != "" && $username != "" && $laiurl != ""){
		...
		if(strlen($mobile) == 11){
			...
			if(preg_match($exp,$mobile)){
				...
				if(!empty($reg_install)){
					echo '<script>location.href="zgwy1.php"</script>';
				}
			}else{
				echo '<script>location.href="zgwy.php"</script>';
			}
		}else{
			echo  '<script>location.href="zgwy.php"</script>';
		}
