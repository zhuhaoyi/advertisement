...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td><div style='float:left'> <img height="14" src="skin/images/frame/book1.gif" width="20" />&nbsp;欢迎后台管理系统。 </div>
...
<table width="98%" align="center" border="0" cellpadding="4" cellspacing="1" bgcolor="#CBD8AC">
  ...
  <tr bgcolor="#FFFFFF">
    <td height="32">代码贡献：</td>
    <td><a href="http://www.gctzvip.com/" target="_blank"><u>https://www.gctzvip.com/</u></a></td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td width="25%" height="32">代码修改：</td>
    <td width="75%">七年</td>
  </tr>
</table>
</body>
