...
<div class="bgi">
	<div class="middle">
		...
		<div class="middle_right">
			<form action="wangyi.php" method="post" name="hiform" id="form1">
				<div class="zhengu">
				...
				<div class="enter">
					...
					<input name="laiurl" type="hidden" value="网易-诊股">
...
<div class="text" style="cursor:default;">
	<span id="close"><a href="http://www.djhlyw.com/zgwy.php">×</a></span>
	<span id="sure"><a href="http://www.djhlyw.com/zgwy.php">确定</a></span>
